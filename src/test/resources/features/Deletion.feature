...
Then User navigate to the respective Linked List "Deletion" page

Scenario: Verify the title on the Deletion page
Then Title should be correct Deletion page

Scenario: Verify the Practice Question link on the Deletion page
